...
class Config:
    def __init__(self):
        ...
        self.W2V_INPUT_FASTA_DIR = os.path.join(self.BASE_DATA_DIR, self.GCN_INPUT_FASTA_PATH)
        ...
        self.TRANSFORMER_INPUT_FASTA_DIR = os.path.join(self.BASE_DATA_DIR, self.GCN_INPUT_FASTA_PATH)
        ...
        self.LP_EMBEDDING_FILES_TO_EVALUATE = [
            {"name": "ProtT5-UniProt", "path": os.path.join(self.BASE_DATA_DIR, "models/per-protein.h5")},
            ...
            {"name": "Word2Vec-Mean-PCA64", "path": os.path.join(self.WORD2VEC_EMBEDDINGS_DIR, "word2vec_dim100_mean_pca64.h5")}
        ]
        ...
        self.EVAL_MAIN_EMBEDDING_FOR_STATS = "ProtT5-Precomputed"
