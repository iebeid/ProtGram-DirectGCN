...
class ProtGramGCNParams(BaseModel):
    ...
    PROTGRAM_DIRECTGCN_PATH_SELECTION: str
    ...
    PROTGRAM_DISABLE_GRAPH_COARSENING: bool = Field(default=False)
...
class Config:
    ...
    def _link_data_sources_to_attributes(self):
        ...
        self.LP_EXTERNAL_EMBEDDINGS_TO_EVALUATE = [
            ...
            {"name": "ProtT5", "path": "results/models/prott5.h5"},
            {"name": "ESM2", "path": "results/models/ESM2_mean_dim320.h5"},
            {"name": "Word2Vec", "path": "results/models/word2vec.h5"},
            {"name": "ProtGram-DirectGCN", "path": "results/models/protgram_directgcn.h5"},
        ]
    ...
    def _setup_gcn_params(self):
        ...
        self.PROTGRAM_DISABLE_GRAPH_COARSENING = params.get('PROTGRAM_DISABLE_GRAPH_COARSENING', False)
